...
export const DefaultSettings: Promise<LoadedSettings> = downloadDir().then(
    (dir) => ({
        General: {
            locale: "en",
...
export const SettingsSchema = {
    ...
    properties: _.mapValues(
            ...
            Reader: {
                ...
                properties: {
                    ...
                    navLayoutPaged: {
                        ...
                        description:
                            "The method of changing pages when reading.",
                    },
                    invertTappingPaged: {
                    ...
                    navLayoutWebtoon: {
                        ...
                        description:
                            "The method of chanigng pages when reading.",
                    },
            ...
            Downloads: {
                ...
                properties: {
                    ...
                    removeWhenMarkedRead: {
                        ...
                        type: "boolean",
                        description:
                            "Remove downloaded chapters when marked read.",
                    },
                    removeAfterRead: {
        ...
        (v) => {
            ...
            const vProps = newV.properties;
            (Object.keys(vProps) as Array<keyof typeof vProps>).forEach((a) => {
                if (a !== "type") (vProps[a] as Record<string, unknown>).id = a;
            });

            return newV as typeof v & { id: string };
        }
    ),
};
